...
author: "M. Branco"
date: "29 setembro 2015"
output: html_document
---

```{r global_options, include=FALSE, echo=FALSE}
options(digits=2)
# setwd("/home/miguel/Documentos/Eventos/ecomicR/markdown_ex/")
...
![Imaxe conmemorativa de actos tralos dez anos da Morte de Ramón Margalef celebrados na [Universidade de Barcelona](www.ub.edu/)](imaxes/logomargalef.jpg)
...
# Load data
tabII <- read.csv("/home/miguel/Documentos/Eventos/ecomicR/markdown_ex/data/tabII.csv", sep=";")
tabII[is.na(tabII)] <- 0
str(tabII)
...
```{r richness, echo=FALSE, include=FALSE}
div <- function(comm){
  require(vegan)
  S <- c()
...
```{r sac, echo=FALSE, warning=FALSE, fig=TRUE, fig.height=4, fig.width=6}
...
```{r wittaker, echo=FALSE, warning=FALSE, fig=TRUE, fig.height=4, fig.width=6}
